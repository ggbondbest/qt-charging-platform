...
const businessErrors: Record<string, string> = {
  UNAUTHORIZED: "演示会话已失效，请重新创建会话后继续。",
  FORBIDDEN: "管理员令牌无效，请检查后重试。",
  ARRIVAL_TOO_EARLY: "模拟时钟尚未到达预计抵达时刻，请稍候或由管理员推进时钟。",
  ACTIVE_TRIP: "你已有进行中的行程，请先完成或取消。",
  RECOMMENDATION_EXPIRED: "这次推荐已过期，请刷新推荐后重新选择。",
  RECOMMENDATION_NOT_FOUND: "这次推荐已不可用，请重新计算推荐。",
  OFFER_ALREADY_USED: "这次推荐已创建行程，请在“我的行程”继续。",
  TRIP_NOT_FOUND: "没有找到可访问的行程，请刷新状态。",
  INELIGIBLE_STATION: "此电站不属于当前有效推荐，请重新推荐。",
  INVALID_TRANSITION: "行程状态已变化，请刷新后按当前步骤继续。",
  CAPACITY_CONFLICT: "背景占用不能挤占用户已分配的电桩，请减少占用数量。",
  INVALID_CONFIG: "配置值超出范围或不完整，请检查数值与权重总和。",
  ...
  EXPERIMENT_RUNNING: "已有实验正在计算，请在模型实验室等待结果。",
};
