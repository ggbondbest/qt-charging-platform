...
| 充电过程异常筛查 | [anomaly/](anomaly/) | iforest-session-battery-v1 v0.1（会话级 IsolationForest） | TEST 首盲已冻结：F1 0.147（正例 4%），弱结果如实呈报——分型召回揭示会话均值稀释瞬时异常，v2 方向（采样点级打分）已写明；见 [anomaly/README.md](anomaly/README.md) |
