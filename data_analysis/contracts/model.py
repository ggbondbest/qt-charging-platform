...
ERROR_CODES = {
    ...
    "RATE_LIMITED", "ADVISOR_BUSY", "ADVISOR_TIMEOUT", "ORIGIN_DENIED",
    "INVALID_CONTENT_TYPE", "REQUEST_TOO_LARGE", "CONSENT_REQUIRED",
    "ONLINE_NOT_CONFIGURED", "ONLINE_UNAVAILABLE", "ONLINE_INVALID_RESPONSE",
    "ONLINE_AUTH_ERROR", "ONLINE_RATE_LIMITED", "ONLINE_MODEL_ERROR",
}
