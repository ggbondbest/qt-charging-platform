// Generated from contracts/delivery_openapi.json. Regenerate; do not hand-edit.
...
export type AdvisorAnswer = { "answer": string; "citations"?: Array<string>; "evidence": Array<Evidence>; "intent": string; "knowledge"?: Array<KnowledgeExcerpt>; "limitations": Array<string>; "mode": "offline" | "online"; "scope": Scope; "status": "answered" | "unsupported" | "no_evidence" | "chat"; "suggestions": Array<Suggestion> };
export type AdvisorConfig = { "defaultMode": "offline" | "online"; "disclosure": string; "maxQuestionLength": number; "onlineAvailable": boolean; "onlineProvider": (string | null); "supportedQuestions": Array<SampleQuestion> };
...
export type DetailedPredictionRequest = { "cityId"?: (string | null); "datasetId"?: (string | null); "horizonHours"?: 1 | 6 | 24; "modelId": string; "publishedBatchId"?: (string | null); "referenceTime": string; "stationId": string; "target": "load" | "availability" };
export type Envelope_AdvancedAnalytics_ = { "code": string; "data": (AdvancedAnalytics | null); "message": string; "meta": Meta };
export type Envelope_AdvisorAnswer_ = { "code": string; "data": (AdvisorAnswer | null); "message": string; "meta": Meta };
export type Envelope_AdvisorConfig_ = { "code": string; "data": (AdvisorConfig | null); "message": string; "meta": Meta };
...
export type Evidence = { "id": string; "label": string; "source": Source; "unit": string; "value": (number | number | string | null) };
...
export type KnowledgeExcerpt = { "id": string; "source": string; "text": string; "title": string };
...
export type SampleQuestion = { "id": string; "label": string; "question": string };
export type Scope = { "cityId": (string | null); "dataKind": "SIMULATED"; "datasetId": string; "endDate": string; "publishedBatchId": string; "startDate": string; "stationId": (string | null); "timeZone": "Asia/Shanghai" };
...
export type Source = { "endpoint": string; "field": string };
...
export type Suggestion = { "label": string; "target": "overview" | "advanced" | "models" | "anomalies" };
...
// GET /api/v1/intelligence/advisor
export type advisorConfigQuery = Record<string, unknown>;
export type advisorConfigResponse200 = Envelope_AdvisorConfig_;

// POST /api/v1/intelligence/advisor
export type advisorAskQuery = Record<string, unknown>;
export type advisorAskBody = { "cityId"?: (string | null); "consent"?: boolean; "datasetId": string; "endDate"?: (string | null); "history"?: Array<HistoryMessage>; "mode"?: "offline" | "online"; "publishedBatchId": string; "question": string; "startDate"?: (string | null); "stationId"?: (string | null) };
export type advisorAskResponse200 = Envelope_AdvisorAnswer_;
export type advisorAskResponse400 = Envelope_dict_;
export type advisorAskResponse403 = Envelope_dict_;
export type advisorAskResponse404 = Envelope_dict_;
export type advisorAskResponse409 = Envelope_dict_;
export type advisorAskResponse413 = Envelope_dict_;
export type advisorAskResponse415 = Envelope_dict_;
export type advisorAskResponse422 = Envelope_dict_;
export type advisorAskResponse429 = Envelope_dict_;
export type advisorAskResponse502 = Envelope_dict_;
export type advisorAskResponse503 = Envelope_dict_;
export type advisorAskResponse504 = Envelope_dict_;

// POST /api/v1/intelligence/forecast
export type forecast_api_v1_intelligence_forecast_postQuery = Record<string, unknown>;
export type forecast_api_v1_intelligence_forecast_postBody = DetailedPredictionRequest;
export type forecast_api_v1_intelligence_forecast_postResponse422 = HTTPValidationError;

// GET /api/v1/intelligence/insights/{kind}
export type insights_api_v1_intelligence_insights__kind__getQuery = { "datasetId"?: (string | null); "publishedBatchId"?: (string | null); "limit"?: number };
export type insights_api_v1_intelligence_insights__kind__getResponse422 = HTTPValidationError;

// GET /api/v1/intelligence/insights/{kind}/{entity_id}
export type insight_detail_api_v1_intelligence_insights__kind___entity_id__getQuery = { "datasetId"?: (string | null); "publishedBatchId"?: (string | null) };
export type insight_detail_api_v1_intelligence_insights__kind___entity_id__getResponse422 = HTTPValidationError;

// GET /api/v1/intelligence/models
export type models_api_v1_intelligence_models_getQuery = { "datasetId"?: (string | null); "publishedBatchId"?: (string | null) };
export type models_api_v1_intelligence_models_getResponse422 = HTTPValidationError;
...
export type predictAvailabilityQuery = Record<string, unknown>;
export type predictAvailabilityBody = PredictionRequest;
export type predictAvailabilityResponse200 = Envelope_PredictionResult_;
export type predictAvailabilityResponse400 = Envelope_dict_;
export type predictAvailabilityResponse404 = Envelope_dict_;
export type predictAvailabilityResponse409 = Envelope_dict_;
export type predictAvailabilityResponse422 = Envelope_dict_;
export type predictAvailabilityResponse500 = Envelope_dict_;
export type predictAvailabilityResponse503 = Envelope_ModelCapabilities_;

// POST /api/v1/predict/load
export type predictLoadQuery = Record<string, unknown>;
export type predictLoadBody = PredictionRequest;
export type predictLoadResponse200 = Envelope_PredictionResult_;
export type predictLoadResponse400 = Envelope_dict_;
export type predictLoadResponse404 = Envelope_dict_;
export type predictLoadResponse409 = Envelope_dict_;
export type predictLoadResponse422 = Envelope_dict_;
export type predictLoadResponse500 = Envelope_dict_;
export type predictLoadResponse503 = Envelope_ModelCapabilities_;
