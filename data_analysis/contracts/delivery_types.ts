...
export type AdvisorAnswer = { "answer": string; "evidence": Array<Evidence>; "intent": string; "limitations": Array<string>; "mode": "offline" | "online"; "scope": Scope; "status": "answered" | "unsupported" | "no_evidence"; "suggestions": Array<Suggestion> };
export type AdvisorConfig = { "defaultMode": "offline"; "disclosure": string; "maxQuestionLength": number; "onlineAvailable": boolean; "onlineProvider": (string | null); "supportedQuestions": Array<SampleQuestion> };
...
export type advisorAskBody = { "cityId"?: (string | null); "consent"?: boolean; "datasetId": string; "endDate"?: (string | null); "mode"?: "offline" | "online"; "publishedBatchId": string; "question": string; "startDate"?: (string | null); "stationId"?: (string | null) };
